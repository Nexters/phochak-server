...
public class CancelPhochakApi {

    private Long postId = 1L;

    public CancelPhochakApi postId(final Long postId) {
        this.postId = postId;
        return this;
    }

    public Scenario.NextScenarioStep request() throws Exception {
        final ResultActions response = TestUtil.mockMvc.perform(delete("/v1/post/{postId}/likes/", postId)
