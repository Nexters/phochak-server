...
include::{snippets}/v2/user/login/http-request.adoc[]

Path Parameters

include::{snippets}/v2/user/login/path-parameters.adoc[]

Request Parameters

include::{snippets}/v2/user/login/request-parameters.adoc[]

==== 응답
Response HTTP Example

*정상*
include::{snippets}/v2/user/login/http-response.adoc[]

Response Parameters

include::{snippets}/v2/user/login/response-fields.adoc[]
